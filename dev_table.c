...
/*	{0x467, "STM32G0B0/B1/C1xx"               , 0x20004000, 0x20020000, 0x08000000, x         ,  x, x     , x         , x         , 0x1FFF0000, 0x1FFFF000, 0}, */
/*	{0x456, "STM32G05xxx/061xx"               , 0x20001000, 0x20002000, 0x08000000, x         ,  x, x     , x         , x         , 0x1FFF0000, 0x1FFF2000, 0}, */
	/* G4 */
...
/*	{0x479, "STM32G491xx/A1xx"                , 0x20004000, 0x2001C000, 0x08000000, x         ,  x, x     , x         , x         , 0x1FFF0000, 0x1FFF7000, 0}, */
	/* H7 */
...
/*	{0x480, "STM32H7A3xx/B3xx"                , 0x20004100, 0x20020000, 0x08000000, x         ,  x, x     , x         , x         , 0x1FF00000, 0x1FF14000, 0}, */
	...
	/* L4 */
/*	{0x464, "STM32L412xx/422xx"               , 0x20002100, 0x20008000, 0x08000000, x         ,  x, x     , x         , x         , 0x1FFF0000, 0x1FFF7000, 0}, */
